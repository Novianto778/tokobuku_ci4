...
<main>
  <div class="container-fluid px-4">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <a href="/supplier/create" class="btn btn-primary mb-3" type="button">Tambah Supplier</a>
          ...
          <tbody>
            ...
            foreach ($result as $value) : ?>
              <tr>
                ...
                <td><?= $value->phone ?></td>
                <td>
                  <a href="/supplier/edit/<?= $value->supplier_id ?>" class="btn btn-warning" role="button">Ubah</a>
