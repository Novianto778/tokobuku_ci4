      ...
      <div class="col-xl-6">
        <div class="card mb-4">
          <div class="card-header">
            ...
            <div class="col-sm-2 mt-3">
              <input type="number" id="tahun-pembelian" class="form-control" value="<?= date('Y') ?>" onchange="chartPembelian()">
            </div>
          </div>
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <a id="download-pembelian" download="chart-pembelian.png">
...
<script>
    ...
    var myPieChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          fill: true,
          backgroundColor: [
            '#F241C5', '#83B5BE', '#9BEB42', '#1D082F', '#4A16C2', '#F7B2CB', '#7F0937', '#8351AC', '#EF8DBD', '#E3FC1B', '#B2BBC9', '#926031'
          ],
        }]
      },
      options: {
  ...
  function setLineChartPembelian(dataset) {
    // Area Chart Example
  ...
  function setBarChartSupplier(dataset) {
    // Bar Chart Example
  ...
  function chartSupplier() {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        setBarChartSupplier(dataset)
      }
    });
  }

  function downloadChartImg(download, chart) {
    var img = chart.toDataURL("img/jpg", 1.0).replace("image/jpg", "image/octet-stream")
  ...
  function downloadChartPembelian(type) {
    var download = document.getElementById('download-pembelian')
