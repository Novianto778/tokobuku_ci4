  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="card-body">
          <!-- Form Tambah Majalah -->
          <form action="/majalah/edit/<?= $result['majalah_id'] ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control <?= $validation->hasError('harga') ? "is-invalid" : '' ?>" id="harga" name="harga" value="<?= old('harga', $result['harga']) ?>" harga>
                <div id="validationServer03Feedback" class="invalid-feedback">
